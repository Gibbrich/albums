package com.github.gibbrich.albums.ui
...
class AlbumsViewModel: ViewModel() {
    ...
    @Inject
    internal lateinit var albumsUseCase: com.github.gibbrich.albums.domain.AlbumsUseCase

    init {
        DI.albumsComponent.inject(this)
